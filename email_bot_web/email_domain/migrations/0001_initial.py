    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_service', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='boxes', to='email_domain.emailservice', verbose_name='Почтовый сервис')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='filters', to='email_domain.emailbox', verbose_name='Почтовый ящик')),
            ],
            options={
                'verbose_name': 'Фильтр',
