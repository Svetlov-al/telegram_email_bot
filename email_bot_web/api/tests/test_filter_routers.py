...
import pytest
from api.tests.fixtures.filter_fixtures import FilterData
...
class TestFilters:
    ...
    def test_get_filters_for_box_success(self, api_client: APIClient,
        ...
        print(box_filter1.id, box_filter1.filter_value)
        print(box_filter2.id, box_filter2.filter_value)
